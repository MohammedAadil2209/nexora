      ...
      <div className="container">
        ...
        <div className="section-padding pb-0 mt-5">
          <div className="section-header text-left fade-in-up" style={{ borderBottom: '1px solid var(--border-glass)', paddingBottom: '1.5rem', marginBottom: '2rem' }}>
             <h2 className="section-title" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-2px', marginBottom: '0', color: 'var(--text-main)' }}>Results. <span style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)', color: 'var(--text-muted)', fontWeight: '400', fontFamily: 'var(--font-body)', letterSpacing: '0', display: 'inline-block', verticalAlign: 'middle', paddingLeft: '1rem', borderLeft: '2px solid var(--border-glass)', marginLeft: '1rem' }}>Websites optimized for real results.</span></h2>
          </div>

          <div className="bento-grid fade-in-up">
             
             {/* Feature 1: Tall Architecture Stack (Row span 2) */}
             <div className="bento-card bento-tall glass-panel" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: 'var(--bg-glass)', border: '1px solid var(--border-glass)', paddingBottom: '0' }}>
                <div>
                   <h3 style={{ fontSize: '1.6rem', color: 'var(--text-main)', marginBottom: '0.5rem', fontFamily: 'var(--font-heading)' }}>Proprietary Stack</h3>
             ...
             <div className="bento-card bento-wide glass-panel" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h3 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: 'var(--text-main)', fontFamily: 'var(--font-heading)' }}>Engineered purely for <span className="text-gradient">Maximum Conversion</span></h3>
                <div className="mobile-grid-col-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', opacity: '1' }}>
                   <div style={{ background: 'var(--bg-glass)', padding: '1.5rem 1.2rem', borderRadius: '12px', border: '1px solid var(--border-glass)', opacity: '1' }}>
                      ...
                      <h4 style={{ fontSize: '1.05rem', color: 'var(--text-main)', marginBottom: '0.4rem', opacity: '1' }}>Algorithmic SEO</h4>
                      <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: '0', opacity: '1' }}>Dominate core Google search algorithms from day one.</p>
                   </div>
                   <div style={{ background: 'var(--bg-glass)', padding: '1.5rem 1.2rem', borderRadius: '12px', border: '1px solid var(--border-glass)', opacity: '1' }}>
                      <i className="fa-solid fa-brain text-purple mb-3" style={{ fontSize: '1.5rem', filter: 'drop-shadow(0 0 10px rgba(124,58,237,0.4))' }}></i>
                      <h4 style={{ fontSize: '1.05rem', color: 'var(--text-main)', marginBottom: '0.4rem', opacity: '1' }}>Neuromarketing</h4>
                      <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: '0', opacity: '1' }}>Psychological UI structured strictly to close sales effortlessly.</p>
                   </div>
                   <div style={{ background: 'var(--bg-glass)', padding: '1.5rem 1.2rem', borderRadius: '12px', border: '1px solid var(--border-glass)', opacity: '1' }}>
                      <i className="fa-solid fa-bolt text-green mb-3" style={{ fontSize: '1.5rem', filter: 'drop-shadow(0 0 10px rgba(34,197,94,0.4))' }}></i>
                      <h4 style={{ fontSize: '1.05rem', color: 'var(--text-main)', marginBottom: '0.4rem', opacity: '1' }}>Auto-Pipelines</h4>
                      <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: '0', opacity: '1' }}>Track every click, scroll, and WhatsApp launch natively.</p>
                   </div>
                </div>
             </div>

             {/* Feature 3: Speed Gauge (Square) */}
             <div className="bento-card glass-panel" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', justifyContent: 'space-between', background: 'var(--bg-glass)', border: '1px solid var(--border-glass)' }}>
                <h4 style={{ fontSize: '1.3rem', color: 'var(--text-main)', fontFamily: 'var(--font-heading)', marginBottom: '0' }}>Zero-Lag Architecture</h4>
             ...
             <div className="bento-card glass-panel" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', overflow: 'hidden', position: 'relative', background: 'var(--bg-glass)', border: '1px solid var(--border-glass)' }}>
                <div className="shield-pulse" style={{ position: 'absolute', width: '200px', height: '200px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(34,197,94,0.1) 0%, rgba(34,197,94,0) 70%)', animation: 'pulse-glow 3s infinite' }}></div>
                ...
                <h4 style={{ fontSize: '1.3rem', color: 'var(--text-main)', zIndex: 1, marginBottom: '0.5rem' }}>Bank-Grade Security</h4>
             ...
             <div className="bento-card bento-wide glass-panel mobile-col-swap" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', overflow: 'hidden', background: 'var(--bg-glass)', border: '1px solid var(--border-glass)' }}>
                <div className="cms-text" style={{ maxWidth: '55%', zIndex: 2 }}>
                   <h3 style={{ fontSize: '1.5rem', color: 'var(--text-main)', fontFamily: 'var(--font-heading)', marginBottom: '0.8rem' }}>Universal CMS Dashboard</h3>
                ...
                <div className="cms-graphic" style={{ position: 'relative', width: '40%', height: '160px', zIndex: 1 }}>
                   <div style={{ position: 'absolute', right: '-30px', top: '50%', transform: 'translateY(-50%) rotate(-8deg)', background: 'var(--bg-surface)', border: '1px solid var(--border-glass)', borderRadius: '12px', padding: '1.5rem', width: '280px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', backdropFilter: 'blur(10px)' }}>
                      <div style={{ height: '6px', width: '30%', background: 'rgba(0,0,0,0.05)', borderRadius: '4px', marginBottom: '15px' }}></div>
                      <div style={{ height: '8px', width: '70%', background: 'var(--highlight)', borderRadius: '4px', marginBottom: '15px', boxShadow: '0 0 10px rgba(136,19,55,0.2)' }}></div>
                      <div style={{ height: '35px', width: '100%', background: 'rgba(136,19,55,0.05)', borderRadius: '6px', border: '1px dashed var(--highlight)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><i className="fa-solid fa-pen-to-square text-primary" style={{ fontSize: '0.8rem' }}></i></div>
                   </div>
                </div>
             </div>
